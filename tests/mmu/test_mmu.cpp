...
using namespace boyboy::core::io;
...
TEST_F(MmuTest, MemoryRegionsRW)
{
    ...
    // IO
    mmu->write_byte(IOStart, 0x23);
    EXPECT_EQ(mmu->read_byte(IOStart), 0x23) << "IO register should be writable";
